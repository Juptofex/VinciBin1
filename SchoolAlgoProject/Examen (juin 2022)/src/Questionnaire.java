...
public class Questionnaire {
	...
	public QuestionCM fournirQuestion(){
		...
		int index = unEntierAuHasardEntre(0,nombreQuestionsRestantes-1);
		QuestionCM temp = tableQuestions[index];
		tableQuestions[index] = tableQuestions[nombreQuestionsRestantes-1];
		tableQuestions[nombreQuestionsRestantes-1] = temp;
