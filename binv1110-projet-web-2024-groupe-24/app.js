...
/**
 * Convert the id of the creator of a tournament into it's firstname+name or unknown if there is none with the id provided
 */
hbs.registerHelper('findCreator', function(creatorId) {
  const creator = Tournament.findCoachName(creatorId);
  return creator ? creator.firstname+' '+creator.surname : 'Unknown';
});
