...
public class ListeLRU<E> {
	 ...
	 * @return true l'element supprime ou null si la liste etait vide
	 */
	public E supprimerDernier() {
		//TODO
		if (mapElementNoeud.isEmpty())
			return null;
		Noeud noeud = queue.precedent;
		queue.precedent=noeud.precedent;
		noeud.precedent.suivant=queue;
		mapElementNoeud.remove(noeud.element);
